    ...
    <c:forEach var="review" items="${reviews}">
        <form method="post">
            <tr>
                ...
                <td><input type="text" name="text" value="${review.text}" readonly></td>
                <td><input type="number" name="rating" value="${review.rating}" readonly></td>
                ...
                <td><input type="submit" formaction="/car-showrooms/review/delete" value="Delete"></td>
            </tr>
        </form>
    </c:forEach>
    </tbody>
